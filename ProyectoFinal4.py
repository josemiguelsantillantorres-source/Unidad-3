...
def abrir_acerca_de():
    texto = (
        " ACERCA DE\n"
        "Sistema Punto de Venta - Ropa\n"
        "Versión 1.0\n\n"
        "Este proyecto es una aplicación desarrollada en Python con Tkinter, "
        "creada para facilitar el registro, control y gestión de productos "
        "y ventas en un negocio de ropa.\n\n"
        " OBJETIVO:\n"
        "- Automatizar las ventas del negocio.\n"
        "- Registrar productos de forma rápida y sencilla.\n"
        "- Generar tickets, reportes y cálculos automáticos.\n\n"
        ...
        "- Tkinter\n"
        "- PIL / Pillow\n"
        "- Archivos .txt como base de datos\n\n"
        "Proyecto Escolar\n"
        "Desarrollado por: [Jose Miguel Santillan Torres]\n"
    )
